...
const r11 = (location, callback) => {
  require.ensure(
    [],
    require => {
      callback(null, require("./routes/1-1"));
    },
    "11"
  );
};
const r12 = (location, callback) => {
  require.ensure(
    [],
    require => {
      callback(null, require("./routes/1-2"));
    },
    "12"
  );
};
const r21 = (location, callback) => {
  require.ensure(
    [],
    require => {
      callback(null, require("./routes/2-1"));
    },
    "21"
  );
};
const r22 = (location, callback) => {
  require.ensure(
    [],
    require => {
      callback(null, require("./routes/2-2"));
    },
    "22"
  );
};
const r31 = (location, callback) => {
  require.ensure(
    [],
    require => {
      callback(null, require("./routes/3-1"));
    },
    "31"
  );
};
const r32 = (location, callback) => {
  require.ensure(
    [],
    require => {
      callback(null, require("./routes/3-2"));
    },
    "32"
  );
};
const r33 = (location, callback) => {
  require.ensure(
    [],
    require => {
      callback(null, require("./routes/3-3"));
    },
    "33"
  );
};
const r34 = (location, callback) => {
  require.ensure(
    [],
    require => {
      callback(null, require("./routes/3-4"));
    },
    "34"
  );
};
